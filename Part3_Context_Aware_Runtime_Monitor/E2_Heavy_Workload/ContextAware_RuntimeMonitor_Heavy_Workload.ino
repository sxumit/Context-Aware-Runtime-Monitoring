...
// =====================================================
// CRITICAL MODE DETAILED CHECK INTERVAL
// =====================================================

// Every 10th sample in CRITICAL mode
// receives detailed monitoring.
...
void monitoredTask(void *parameter) {
  ...
  Serial.println(
    "P3-E2 - UNIVERSAL ADAPTIVE MONITOR"
  );
